<script setup>
import { ref } from 'vue';
import ShapeGameOptionsbg from '../assets/images/shapeGameOptionsBg.png';
...
<template>
  <div class="shape" :style="{ backgroundImage: `url(${ShapeGameOptionsbg})`}">
    ...
    <div class="shape__clouds-1">
        ...
        <img class="shape__cloud" :src="cloud5" alt="Desafio 5 do jogo de ligar pontos com formas.">
    </div>
    <div class="shape__clouds-2">
        <img class="shape__cloud" :src="cloud6" alt="Desafio 6 do jogo de ligar pontos com formas.">
        <img class="shape__cloud" :src="cloud7" alt="Desafio 7 do jogo de ligar pontos com formas.">
        <img class="shape__cloud" :src="cloud8" alt="Desafio 8 do jogo de ligar pontos com formas.">
        <img class="shape__cloud" :src="cloud9" alt="Desafio 9 do jogo de ligar pontos com formas.">
        <img class="shape__cloud" :src="cloud10" alt="Desafio 10 do jogo de ligar pontos com formas.">
    </div>
  </div>
</template>
